# Projetos Relevantes
O intuito deste repositório é permitir que os projetos desenvolvidos por Gabriel Malara Leal Dos Santos sejam devidamente exibidos e acessados por visitantes e recrutadores. Nenhum dos arquivos que estão armazenados aqui foi gerado por IAs generativas ou por outras pessoas.

Cada projeto pode ser explicado pelo autor e executado pelos visitantes e recrutadores.
...
2.1. Qual é a altura desejada para o quadrado?<br>
...
Abaixo está uma imagem que mostra qual é cada posição no tabuleiro.
![tabuleiro do jogo da velha](images/jogo-da-velha.png)

3. Após o envio da posição desejada, o próximo jogador deve executar qual é a posição que ele deseja jogar.
4. O código termina a execução quando algum usuário ganha ou quando existe empate.